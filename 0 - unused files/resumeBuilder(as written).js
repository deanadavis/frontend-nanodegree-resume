...
var bio = {
  ...
  "skills": ["Mechanical Engineering (20+ years)", "Wind Turbine Engineering",
             "Wind Turbine Testing", "Data Collection & Processing", "Web Development"
  ]
};
...
var gear = "<iframe src='gears2.html' align='right' scrolling='no' frameborder='0'></iframe>";
...
function displaySkills() {
  for (skillsCount=0; skillsCount<bio.skills.length; ++skillsCount) {
...
function displaySchools() {
  for (schoolsCount=0; schoolsCount<education.schools.length; ++schoolsCount) {
    ...
    var formattedSchoolDates = HTMLschoolDates.replace("%data%",
        education.schools[schoolsCount].date);
